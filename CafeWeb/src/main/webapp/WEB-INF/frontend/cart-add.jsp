...
<div class="container">
    ...
    <div class="row mt-4">
        ...
        <div class="col-md-4 d-flex align-items-center ml-3">
            <form id="purchaseForm" action="addCart" method="post" class="w-100">
                ...
                <button type="button" class="btn btn-primary mt-3" onclick="confirmPurchase()">Thêm vào giỏ</button>
            </form>
        </div>
...
<script>
    function confirmPurchase() {
        ...
        swal({
            ...
            text: "Bạn có chắc chắn muốn thêm " + quantity + " sản phẩm?",
            type: "warning",
