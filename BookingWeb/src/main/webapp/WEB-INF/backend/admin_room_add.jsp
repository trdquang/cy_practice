...
<body>
<form class="form-container" action="admin_room_add" method="POST" enctype="multipart/form-data">
    <h2>Thêm Phòng</h2>
    <div class="form-row">
        <div class="form-group col-md-6">
            ...
            <input type="number" class="form-control" id="roomPrice1" name="roomPrice1" required>

            <label for="roomPrice2">Giá 2:</label>
            <input type="number" class="form-control" id="roomPrice2" name="roomPrice2" required>
